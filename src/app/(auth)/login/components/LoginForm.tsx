...
export const LoginForm = ({ onChange, onSubmit }: LoginFormProps) => {
    return (
        <div className="flex min-h-screen items-center justify-center text-black">
            <form onSubmit={onSubmit} className="w-full max-w-sm space-y-4 rounded-2xl bg-white p-6 shadow-md">
                <h2 className="text-center text-2xl font-semibold text-black">Iniciar sesión</h2>
                ...
                <button type="submit" className="w-full rounded-xl border-gray-600 bg-blue-600 py-2 text-white transition hover:bg-blue-700">
                    Ingresar
                </button>
