...
export default function Envios() {
  return(<DynamicCRUD<paquete, envioPayload>formConfig={formConfig} getColumns={getColumns}  service={envioService} initState={initState} checks={true} id='tracking'></DynamicCRUD>)
}
